...
const App: React.FC = () => {
  ...
  const [loading, setLoading] = useState(false); // QR generation loading
  const [initialLoading, setInitialLoading] = useState(true); // Startup loading
  ...
  return (
    <div className="app-container">
      <StartupLoader loading={initialLoading} /> {/* Startup loader */}
      {loading && <Preloader loading={loading} />} {/* QR generation loader */}
      {!initialLoading && (
        <>
          {toast && (
